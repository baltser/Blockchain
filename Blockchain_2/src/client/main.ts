...
let renderingIsInProgress = false;     //флаг для предотвращения двойного отображения
let application = new Application(async () => {       //передает обатный вызов экземпляру Application
